...
# Reverse-proxy (Apache) HTTPS awareness
SECURE_PROXY_SSL_HEADER = ("HTTP_X_FORWARDED_PROTO", "https")

# Security headers (enable HSTS later when SSL confirmed)
...
# App integration paths (read-only; keep dev webhook unchanged)
...
# Optional field encryption key (Fernet)
